...
function Library:create(options)
	...
	local homeButtonIcon = homeButton:object("ImageLabel", {
		...
		Image = "http://www.roblox.com/assets/?id=18544003706",
		Theme = {ImageColor3 = "StrongText"}
	})
	...
	creditsTab:credit{Name = "BLITZ PARADOX⚡", Description = "UI Icon Developer", Discord = "hmmshoot", github = "not yet bro"}
	creditsTab:credit{Name = "🌀EXP PLAYER", Description = "UI Library Developer", Discord = "minecrafter150", bl1tz_paradox = "Print("Hello EXP PLAYER!") , bl1tz_paradox"}

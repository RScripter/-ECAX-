...
local UserInputService = game:GetService("UserInputService")
local toggleState = true  -- Initial state is enabled

local gui = game:GetService("StarterGui"):WaitForChild("ToggleUI")
local guiClone = gui:Clone()
guiClone.Parent = game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui")

UserInputService.InputBegan:Connect(function(input, gameProcessed)
    if not gameProcessed and input.KeyCode == Enum.KeyCode.T then
        if game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"):FindFirstChild("ToggleUI") then
            toggleState = not toggleState
            game:GetService("Players").LocalPlayer.PlayerGui.ToggleUI.Enabled = toggleState
        end
    end
end)

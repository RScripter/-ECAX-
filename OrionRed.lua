...
--Icons https://github.com/RScripter/-ECAX-/blob/main/icons.json - Created by ExploiterPlayer/PlayerExploits
local Icons = {}

local Success, Response = pcall(function()
	Icons = HttpService:JSONDecode(game:HttpGetAsync("https://raw.githubusercontent.com/RScripter/-ECAX-/main/icons.json")).icons
end)

...
G2L["13c"]["Active"] = true;
G2L["13c"]["Text"] = [[ECAX - Keyboard Script]];
G2L["13c"]["Name"] = [[Title]];
...
G2L["147"]["Active"] = true;
G2L["147"]["Text"] = [[ECAX - Keyboard Script - Settings Floating Key]];
G2L["147"]["Name"] = [[Title]];
...
G2L["156"]["Image"] = [[rbxassetid://18671373340]];
...
local function C_138()
	...
	IsSelecting:GetPropertyChangedSignal("Value"):Connect(function()
		if IsSelecting.Value == true then
			script.Parent.Title.Text = "ECAX - Keyboard Script (Selecting Key)"
		elseif IsSelecting.Value == false then
			script.Parent.Title.Text = "ECAX - Keyboard Script"
		end
	end)
